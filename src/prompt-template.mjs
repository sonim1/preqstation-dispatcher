...
export function renderPrompt({
  ...
  return [
    ...
    "6) Prototype-style asks may generate local artifacts and may publish them only through a safe private provider using a private-or-skip policy. If Ask Hint is present, treat it as optional note-rewrite guidance rather than a new workflow requirement.",
